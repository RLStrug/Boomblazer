...
class Test_CLI_Config(unittest.TestCase):
    ...
    def test_up_commands_default_value(self) -> None:
        ...
        self.assertEqual(
            self.config.up_commands,
            _CLI_Config._DEFAULT_UP_COMMANDS,
    ...
    def test_down_commands_default_value(self) -> None:
        ...
        self.assertEqual(
            self.config.down_commands,
            _CLI_Config._DEFAULT_DOWN_COMMANDS,
    ...
    def test_left_commands_default_value(self) -> None:
        ...
        self.assertEqual(
            self.config.left_commands,
            _CLI_Config._DEFAULT_LEFT_COMMANDS,
    ...
    def test_right_commands_default_value(self) -> None:
        ...
        self.assertEqual(
            self.config.right_commands,
            _CLI_Config._DEFAULT_RIGHT_COMMANDS,
    ...
    def test_bomb_commands_default_value(self) -> None:
        ...
        self.assertEqual(
            self.config.bomb_commands,
            _CLI_Config._DEFAULT_BOMB_COMMANDS,
    ...
    def test_quit_commands_default_value(self) -> None:
        ...
        self.assertEqual(
            self.config.quit_commands,
            _CLI_Config._DEFAULT_QUIT_COMMANDS,
    ...
    def test_ready_commands_default_value(self) -> None:
        ...
        self.assertEqual(
            self.config.ready_commands,
            _CLI_Config._DEFAULT_READY_COMMANDS,
