...
class TestBaseConfig(unittest.TestCase):
    ...
    def test_load_none(self) -> None:
        ...
        self.assertFalse(
            self.mockup_config.load({}), "Load of 0 fields / 2 did not return False"
        )
        self.assertEqual(
            self.mockup_config, MockupConfig(1, "ABC"), "Load of 0 fields modified data"
        )
    ...
    def test_dump(self) -> None:
        ...
        self.assertEqual(
            mockup_dump, {"i": 2, "s": "def"}, "Dump did not copy data correctly"
        )
